...
export const LinkCard: React.FC<LinkCardProps> = ({ link, onDelete, baseUrl }) => {
    ...
    <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm hover:shadow-md transition-all duration-200 animate-slide-up group">
      <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
        ...
        <div className="flex-1 min-w-0 w-full">
          ...
          <div className="space-y-3">
            {/* Short URL Row */}
            <div className="flex items-center gap-3 p-2 bg-slate-50 rounded-lg border border-slate-100 group-hover:border-indigo-100 transition-colors">
      ...
      <div className="mt-4 pt-3 border-t border-slate-100 flex justify-between items-center">
        <div className="flex items-center gap-1 text-xs text-slate-500">
          ...
          <span className="font-semibold text-slate-700">{link.clicks}</span> visits
        </div>
